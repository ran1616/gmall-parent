...
public interface SkuFeignClient {
    ...
    Result<CategoryView> findCategoryViewBySkuId(@PathVariable(value = "skuId")Long skuId) ;

    @GetMapping(value = "/api/inner/product/findSkuInfoAndImageBySkuId/{skuId}")
    Result<SkuInfo> findSkuInfoAndImageBySkuId(@PathVariable(value = "skuId")Long skuId) ;

    @GetMapping(value = "/api/inner/product/findSkuInfoBySkuId/{skuId}")
    Result<SkuInfo> findSkuInfoBySkuId(@PathVariable(value = "skuId")Long skuId) ;

    @GetMapping(value = "/api/inner/product/findSpuSalAttrBySkuId/{skuId}")
    Result<List<SpuSaleAttr>> findSpuSalAttrBySkuId(@PathVariable(value = "skuId")Long skuId) ;

    @GetMapping(value = "/api/inner/product/findSkuAttrValueConcatBySkuId/{skuId}")
    Result<List<AttrValueConcatVo>> findSkuAttrValueConcatBySkuId(@PathVariable(value = "skuId")Long skuId) ;
